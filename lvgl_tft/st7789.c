...
void st7789_init(void) {
  ...
  //         {ST7789_MADCTL, {0x00}, 1}, // Set to 0x28 if your display is
  //         flipped {ST7789_COLMOD, {0x55}, 1},
  ...
  //         {ST7789_PVGAMCTRL, {0xD0, 0x00, 0x02, 0x07, 0x0A, 0x28, 0x32, 0x44,
  //         0x42, 0x06, 0x0E, 0x12, 0x14, 0x17}, 14}, {ST7789_NVGAMCTRL, {0xD0,
  //         0x00, 0x02, 0x07, 0x0A, 0x28, 0x31, 0x54, 0x47, 0x0E, 0x1C, 0x17,
  //         0x1B, 0x1E}, 14}, {ST7789_CASET, {0x00, 0x00, 0x00, 0xEF}, 4},
...
/* The ST7789 display controller can drive up to 320*240 displays, when using a
 * 240*240 or 240*135 displays there's a gap of 80px or 40/52/53px respectively.
 * 52px or 53x offset depends on display orientation. We need to edit the
 * coordinates to take into account those gaps, this is not necessary in all
 * orientations. */
void st7789_flush(lv_disp_drv_t *drv, const lv_area_t *area,
